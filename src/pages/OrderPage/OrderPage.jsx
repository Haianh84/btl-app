...
import StepCompoent from "../../components/StepCompoent/StepCompoent"
...
import { WrapperInputNumber } from '../../components/ProductDetailsCompoent/style'
import { convertPrice } from '../../utils';
import InputCompoent from '../../components/InputCompoent/InputCompoent';
import ModalCompoent from '../../components/ModalCompoent/ModalCompoent';
...
const OrderPage = () => {
    ...
    return (
        <div style={{ background: '#f5f5fa', with: '100%', height: '100vh' }}>
                ...
                <div style={{ display: 'flex', justifyContent: 'center' }}>
                    <WrapperLeft>
                        ...
                        <WrapperStyleHeaderDilivery>
                            <StepCompoent items={itemsDelivery} current={diliveryPriceMemo === 10000
            ...
            <ModalCompoent title="Cập nhật thông tin giao hàng" open={isOpenModalUpdateInfo} onCancel={handleCancleUpdate} onOk={handleUpdateInforUser}>
                <Loading isPending={isPending}>
                    ...
                    >
                        ...
                        >
                            <InputCompoent value={stateUserDetails['name']} onChange={handleOnchangeDetails} name="name" />
                        </Form.Item>
                        <Form.Item
                            label="City"
                            name="city"
                        ...
                        >
                            <InputCompoent value={stateUserDetails['city']} onChange={handleOnchangeDetails} name="city" />
                        </Form.Item>
                        <Form.Item
                            label="Phone"
                            name="phone"
                        ...
                        >
                            <InputCompoent value={stateUserDetails.phone} onChange={handleOnchangeDetails} name="phone" />
                        </Form.Item>
                        ...
                        >
                            <InputCompoent value={stateUserDetails.address} onChange={handleOnchangeDetails} name="address" />
                        </Form.Item>
                    </Form>
                </Loading>
            </ModalCompoent>
